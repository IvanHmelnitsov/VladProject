...
const questions = [
  {
    question: 'яка криптовалюта найдорожчча?',
    answers: [
  ...
  {
    question: 'яке спеціальне обладнання використовують майнери?',
    answers: [
  ...
  {
    question: 'яка автомобільна компанія є найдорожчою в світі?',
    answers: [
  ...
  {
    question: 'яка країна найбільш технологічно розвинута?',
    answers: [
    ...
    {
      question: 'в якому штаті розташована штаб-квартира Google?',
      answers: [
    ...
    {
      question: 'в якому штаті розташована штаб-квартира Microsoft?',
      answers: [
    ...
    {
      question: 'в якому році був створений Bitcoin',
      answers: [
    ...
    {
      question: 'в якому році була створена компанія nVidia?',
      answers: [
        { text: '2007', correct: false },
    ...
    {
      question: 'в якому році була створена компанія Intel?',
      answers: [
    ...
    {
      question: 'в якому році був створена компанія AMD?',
      answers: [
    ...
    {
      question: 'яка найдавніша операційна система?',
      answers: [
